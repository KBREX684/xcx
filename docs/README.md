# Agent Control Plane Documentation Set
...
- 面向产品/设计：优先看 PRD、系统架构中的信息架构和关键流程
...
1. 输出低保真原型和信息架构图
2. 初始化 monorepo 与基础工程规范
3. 先打通一个 OpenAPI Agent 接入闭环
4. 跑通一个最小交付流程并生成首份证明书
5. 邀请 3-5 位真实 OPC 用户试用
